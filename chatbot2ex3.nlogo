...
to background-image
  ...
  if (bot = "Liza")  [clear-drawing  import-drawing "smileyface.png"]
  if (bot = "Harry") [clear-drawing  import-drawing "sadface.png"]
  if (bot = "Both")  [clear-drawing  import-drawing "confusedface.png"]
end
