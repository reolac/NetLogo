...
to setup
  ...
  [ set liza who
    ...
    (list
      ...
      setup-rule "(.+)up(.+)" (list "nothing much" "nada" "no plans yet!")
      setup-rule "(.+)day" (list "isn't it just" "yeah it's ok" "wonderful")
      setup-rule "(.+)food" (list "i like food, food is good" "chocolate!" "chips")
